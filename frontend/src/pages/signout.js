...
//       <img src={Background} alt="Background" className="backimg-signout" />
//       {showPopup && (
//         <div className='popup'>
...
//             <button type='button' className='yes' onClick={handleSignout}>
//               Yes
//             </button>
...
//       )}
//       {!showPopup && (
//         <button type='button' className='back-home' onClick={handleBackToHome}>
//           Back to Home
//         </button>
//       )}
//     </div>
