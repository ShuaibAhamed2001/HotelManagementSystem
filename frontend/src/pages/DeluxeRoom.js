  ...
  return (
    <div className="room-container">
      ...
      <div className="room-info-container">
        <h2>Apartment</h2>
        <p>
          Apartment is can reserved for more than 5 guests. There is a bedroom with a
          double-size one beds and a private bathroom.
        </p>
        <div className="room-details">
          <p className="guest-info">
            No of Guests: <span>5</span>| Room Size: <span>200 m²</span>|Bed
            Size: <span>Two Double</span> |Private Bath: <span>2</span>
          </p>
          <ul>
            <li>Wifi</li>
            <li>Mini Bar</li>
